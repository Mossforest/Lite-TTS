...
#     -t 100 \
#     -s 0 \
#     --n_bits_w 8 --channel_wise --n_bits_a 8  --act_quant --order together --wwq --waq --awq --aaq \
#     --weight 0.01 --input_prob 0.5 --prob 0.5 --iters_w 100 --calib_num_samples 16 \
#     --calib_im_mode noise_backward_t \
#     --calib_t_mode normal --calib_t_mode_normal_mean 0.8 --calib_t_mode_normal_std 0.1
